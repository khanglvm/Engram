...
use treerag_context::{ContextManager, ContextRenderer, MemoryStore, ScopeRequest};
use treerag_core::{Metrics, ProjectManager};
use treerag_indexer::storage::Storage;
use treerag_ipc::{ErrorCode, Request, RequestHandler, Response, ResponseData};
use uuid::Uuid;
        ...
        match request {
            ...
            Request::GraftExperience { cwd, experience } => {
                ...
                let mut ctx_experience =
                    treerag_context::Experience::new(&experience.agent_id, &experience.decision)
            ...
            Request::MemoryPut { cwd, entry } => {
                ...
                let stored_entry = treerag_ipc::MemoryEntry {
                    id: id.clone(),
                    kind: entry.kind,
...
mod tests {
    ...
    use treerag_core::DaemonConfig;
    use treerag_ipc::{MemoryEntry, MemoryPatch};
